...
The homepage SHALL display a full-viewport hero section with a dark atmospheric background (image or gradient), the brand name "Автобізнесмени", an H1 headline "Твоя тачка в надійних руках", and exactly 3 primary CTA buttons: "Заїхати на СТО", "Шиномонтаж", "Купити/Продати авто". All CTA buttons SHALL be visually prominent with industrial styling (sharp corners, heavy border, accent color).
